...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230303_miramondoviaggi_447b4446fcfb49ac2164_20230303162622_archive.zip';
        const ARCHIVE_SIZE       = '419500';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '447b444-03162622';
        const SECONDARY_PACKAGE_HASH = 'f8ec677-03162622';
